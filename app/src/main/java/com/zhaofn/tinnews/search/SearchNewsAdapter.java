...
import com.zhaofn.tinnews.R;//R是android resource lookup
...
public class SearchNewsAdapter extends RecyclerView.Adapter<SearchNewsAdapter.SearchNewsViewHolder> {
    ...
    @Override
    public void onBindViewHolder(@NonNull SearchNewsViewHolder holder, int position) {//每一次滑动都反复的使用一个view去render
        ...
        if (article.urlToImage != null) {
                  Picasso.get().load(article.urlToImage).resize(200, 200)
                    .into(holder.itemImageView);//放进某个view
               }
